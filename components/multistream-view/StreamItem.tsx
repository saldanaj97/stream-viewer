...
export const StreamItem = ({ stream, index }: StreamItemProps) => {
  return (
    <div className="stream-container relative overflow-hidden rounded-lg shadow-md">
      <div className="stream-overlay absolute left-0 right-0 top-0 z-10 flex h-[26px] cursor-move items-center justify-between bg-black bg-opacity-50 px-2">
      ...
      <div className="h-full w-full pt-[26px]">{renderEmbed(stream)}</div>
    </div>
  );
};
