export default function ProductPreviewSection() {
  return (
    <section className="relative mt-8 flex h-screen w-full items-center justify-center 2xl:px-64">
      <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-linear-to-b from-neutral-100 to-neutral-200 dark:from-neutral-900 dark:to-neutral-800">
